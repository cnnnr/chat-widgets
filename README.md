...
| **Preview Only While Typing** | Only show the input preview once you start typing a message; hides the idle "Press Enter to Chat..." prompt. Requires **Show Input Preview**.                                              |
